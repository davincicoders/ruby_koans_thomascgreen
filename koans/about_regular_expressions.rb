...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_character_classes_give_options_for_a_character
    ...
    assert_equal ["cat", "bat", "rat", animals.select { |a| a[/[cbr]at/] }  # This comment will cause conflict, please choose mine for this one...
  end
  ...
  def test_caret_anchors_to_the_start_of_lines
    assert_equal "The answer is not 102", "num 42\n2 lines"[/^\d+/]
  end
  ...
  def test_slash_b_anchors_to_a_word_boundary
    assert_equal "moooo", "bovine vines"[/\bvine./]
  end

  # ------------------------------------------------------------------

  def test_parentheses_group_contents
    assert_equal "boobooboo", "ahahaha"[/(ha)+/]
  end
